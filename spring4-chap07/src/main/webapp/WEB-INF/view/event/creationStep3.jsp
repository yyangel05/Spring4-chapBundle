...
<form:form commandName="eventForm" action="/yytest/newevent/done">

<label>이벤트 명</label>: <c:out value="${evemtForm.name }"/><br/>
<label>타임</label>: ${eventForm.type } <br/>
...
<a href="/yytest/newevent/step2">[이전 단계로]</a>
